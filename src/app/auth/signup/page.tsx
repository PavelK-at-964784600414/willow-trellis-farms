  ...
  if (success) {
    return (
      <div className="min-h-screen" style={{backgroundColor: '#D9D7D3'}}>
        <Navigation />
        <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 pt-28">
          <div className="max-w-md w-full space-y-8">
            <div className="text-center">
              <h2 className="text-3xl font-bold" style={{color: '#000000'}}>Success!</h2>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium" style={{color: '#000000'}}>
                  Full Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-medium" style={{color: '#000000'}}>
